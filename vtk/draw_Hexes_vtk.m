function draw_Hexes_vtk(X,Hexes,CBC,fldr,str,imode)
...
switch format
  case 'ascii'
    ...
    if (data_type==1)
      ...
      fprintf(fid,'SCALARS bcid int 1\n');
  ...
  case 'binary'
    ...
    if (data_type==1)
      ...
      write_a(fid,'SCALARS bcid int 1');
...
fprintf(['    vtk: dump %d Hexes into ' fname ' (%3.1f %s, %2.4e sec)\n'],nH,osize,otype,toc(t0))
