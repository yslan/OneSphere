function [JACM3,err]=chk_hex(X,Hexes,str,verbose)
t0=tic;
...
if(verbose>1); fprintf('    done chk1 (%2.4e sec)\n',toc(t1)); end
...
if (verbose>1) fprintf('    done chk2 (%2.4e sec)\n',toc(t1)); end
...
if (verbose>1); fprintf('    done chk3 (%2.4e sec)\n',toc(t1)); end

% chk4: isnan
t1=tic;
err4=find(isnan(X));
if (verbose>1); fprintf('    done chk4 (%2.4e sec)\n',toc(t1)); end
